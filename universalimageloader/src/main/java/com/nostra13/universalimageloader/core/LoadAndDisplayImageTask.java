 ...
 * display it in {@link ImageAware} using {@link com.nostra13.universalimageloader.core.DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public LoadAndDisplayImageTask(com.nostra13.universalimageloader.core.ImageLoaderEngine engine, ImageLoadingInfo imageLoadingInfo, Handler handler) {
		this.engine = engine;
	...
	static void runTask(Runnable r, boolean sync, Handler handler, com.nostra13.universalimageloader.core.ImageLoaderEngine engine) {
		if (sync) {
			r.run();

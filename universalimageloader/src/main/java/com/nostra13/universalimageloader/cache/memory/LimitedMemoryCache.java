...
public abstract class LimitedMemoryCache extends BaseMemoryCache {
	...
	public boolean put(String key, Bitmap value) {
		...
		// Add value to soft cache,(始终会放入 softMap 中);
		super.put(key, value);
	...
	public Bitmap remove(String key) {
		Bitmap value = super.get(key);// 弱引用;
		if (value != null) { // hardCache 中是强引用，此处若为空，说明hardCache中已 remove 了该 bitmap;
			if (hardCache.remove(value)) { // 是否 value 为 null时，hardCache 就不需要

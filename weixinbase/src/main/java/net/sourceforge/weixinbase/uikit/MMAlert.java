package net.sourceforge.weixinbase.uikit;
...
import net.sourceforge.weixinbase.R.id;
import net.sourceforge.weixinbase.R.layout;
import net.sourceforge.weixinbase.R.string;
import net.sourceforge.weixinbase.R.style;
import net.sourceforge.weixinbase.R.drawable;

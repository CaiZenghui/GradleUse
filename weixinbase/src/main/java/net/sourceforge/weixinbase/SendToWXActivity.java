...
import net.sourceforge.weixinbase.uikit.CameraUtil;
import net.sourceforge.weixinbase.uikit.MMAlert;
...
public class SendToWXActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		api = WXAPIFactory.createWXAPI(this, Constants.getWXAppId(this));
